...
<details>
<summary><strong>Business Assumptions</strong></summary>
...
<details>
<summary><strong>Data Aggregation Layer</strong></summary>
...
- `1_generate_production_data.py` -> generates the base production dataset
- `2_sanity_checks.py` -> validates consistency across generated fields
- `3_generate_tables.py` -> creates aggregated reporting tables
- `production_data.csv` -> detailed production dataset
- `production_data_enriched.csv` -> enriched production dataset
- `machine_performance.csv`, `production_by_month.csv`, `production_by_plant.csv`, `shift_performance.csv` -> aggregated reporting tables
- `production-efficiency-dashboard.pbix` -> Power BI dashboard file
- `production_overview.png`, `machine_performance.png`, `shift_efficiency.png` -> dashboard screenshots
